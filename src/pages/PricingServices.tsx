...
export function PricingServices({ t, onBookDemo, onContactClick }: { t: any, onBookDemo: () => void, onContactClick: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-background pt-24 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 relative z-10">
        ...
        <div className="mb-32">
          ...
          >
            <div className="bg-surface-container-low border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 shadow-sm">
